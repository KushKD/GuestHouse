...
public class RestApi {
    ...
    public String GetHotelDetails(String assemblyCode) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "GetMemberDetails");
        p.put("assemblyCode",mapObject(assemblyCode));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
//        result = new JSONObject(r);
